      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              AutoSizeText(
                Servicetheme.getlocal() == 'ar'
                    ? widget.carts.productName ?? widget.carts.productNameEn
                    : widget.carts.productNameEn ?? widget.carts.productName,
                maxLines: 3,
                style: TextStyle(
                  fontSize: 16,
    ...
    API(context).post('delete/from/cart', {
      ...
      if (value != null) {
        if (value['status_code'] == 200) {
          ...
          showDialog(
              context: context, builder: (_) => ResultOverlay(value['errors']));
        }
      }
    });
  }
