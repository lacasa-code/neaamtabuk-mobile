        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                'بيان سياسة الخصوصية هذا يوضح كيف يستخدم و يحمي متجر تركار  أي معلومات يتم جمعها عند استخدام هذا الموقع. ويلتزم متجر تركار بضمان حماية خصوصيتك ومعلوماتك. حيث سوف يطلب منك تقديم بعض المعلومات التي يمكن التعرف من خلالها على هويتك عند استخدام هذا الموقع، ولن يتم استخدام هذه المعلومات إلا وفقاً لبيان سياسة الخصوصية. علماَ أنه قد تتغير سياسة الخصوصية لمتجر تركار من وقت لآخر عن طريق تحديث هذه الصفحة فيجب عليك مراجعة هذه الصفحة من وقت لآخر للتأكد من مناسبة هذه التغييرات ما يتم جمعه من معلومات',
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w500,
                ),
