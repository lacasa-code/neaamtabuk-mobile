...
import 'file:///C:/Users/omarh/AndroidStudioProjects/flutter_pos/lib/screens/Maintenance.dart';
...
class API {
  ...
  Delete(String url) async {
    final String full_url = '${GlobalConfiguration().getString('api_base_url')}$url';
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    try {
